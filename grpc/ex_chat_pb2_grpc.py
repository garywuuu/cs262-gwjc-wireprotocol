...
import ex_chat_pb2 as data__pb2
...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChatStream = channel.unary_stream(
                ...
                response_deserializer=data__pb2.Note.FromString,
                )
        self.SendNote = channel.unary_unary(
                '/grpc.ChatServer/SendNote',
                request_serializer=data__pb2.Note.SerializeToString,
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChatStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=data__pb2.Note.SerializeToString,
            ),
            'SendNote': grpc.unary_unary_rpc_method_handler(
                    servicer.SendNote,
                    request_deserializer=data__pb2.Note.FromString,
...
class ChatServer(object):
    ...
    def SendNote(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/grpc.ChatServer/SendNote',
            data__pb2.Note.SerializeToString,
